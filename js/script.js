...
! function(e) {
	...
	d.length > 0 && d.each(function() {
		...
		t = s >= 3 ? 3 : s,
		l = t >= 2 ? 2 : t,
		n = a.data("delay") ? a.data("delay") : 3000,
		i = a.data("delay") ? a.data("delay") : 1000,
//		r = a.data("loop"),
		o = !!a.data("dots"),
		c = !!a.data("navs"),
...
//	});
	...
	// color switch
	n.append('<div id="color-switch" class="colorPanel cp-custom"><a class="cart" href="https://themeforest.net/item/industrial-industry-and-engineering-services-template/20439885?ref=softnio" target="_blank"></a><a id="cpToggle" href="#"></a><ul></ul></div>');
